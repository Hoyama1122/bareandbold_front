...
1. **Planning & Requirement Analysis:** เพื่อวิเคราะห์ความต้องการ รวบรวมขอบเขตหน้าที่ และกำหนดฟังก์ชันการทำงานหลักของระบบ ทั้งฝั่งหน้าร้าน (Storefront) และระบบบริหารจัดการหลังบ้าน (Backoffice)
2. **System & Database Design:** เพื่อออกแบบโครงสร้างข้อมูล (Database Schema / ER-Diagram) และออกแบบส่วนติดต่อผู้ใช้งาน (UI/UX) ที่มีเสถียรภาพ ตอบสนองการสั่งสินค้าปกติและสินค้าสั่งทำพิเศษ (Made-to-Order) ได้เป็นอย่างดี
3. **System Development:** เพื่อพัฒนาระบบ e-Commerce ที่ประกอบด้วย Frontend (Next.js) และ Backend API (Hono) ที่มีประสิทธิภาพสูง พร้อมเชื่อมต่อกับ Omise Payment Gateway สำหรับรับชำระเงิน และระบบจำลองขนส่ง Mock Shipping API
4. **System Testing:** เพื่อทำการทดสอบระบบแบบ Functional Testing และจำลองสถานการณ์ UAT ร่วมกับ Postman เพื่อตรวจสอบความปลอดภัย ความถูกต้องของตรรกะทางธุรกิจ และการรับส่งข้อมูลของระบบ
5. **Deployment & Maintenance:** เพื่อติดตั้งระบบ (Deploy) ให้สามารถใช้งานได้จริงบนโปรดักชัน พร้อมทำเอกสารคู่มือสถาปัตยกรรมระบบเพื่อให้ง่ายต่อการดูแลรักษาและปรับปรุงระบบในอนาคต
